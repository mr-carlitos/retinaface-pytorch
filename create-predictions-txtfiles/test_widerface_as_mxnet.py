...
parser.add_argument('-m', '--trained_model', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-06-11_CROSSATTENTION_FROMUPPERANDLOWER_PYRAMIDIAL_query_focused_residualconn/CROSSATTENTION_FROMUPPERANDLOWER_PYRAMIDIAL_queryfocusedresconn_final.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-06-11_CROSSATTENTION_FROMUPPERANDLOWER_PYRAMIDIAL_query_focused_residualconn/like-mxnet/', type=str, help='Dir to save txt results')
