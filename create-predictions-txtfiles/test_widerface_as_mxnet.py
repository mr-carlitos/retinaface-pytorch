...
parser.add_argument('-m', '--trained_model', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-06-25_UPPER/UPPER_final.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-06-25_UPPER/like-mxnet/', type=str, help='Dir to save txt results')
