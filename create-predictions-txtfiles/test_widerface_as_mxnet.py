...
parser.add_argument('--save_folder', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-06-22_NOPOSENC/like-mxnet/', type=str, help='Dir to save txt results')
