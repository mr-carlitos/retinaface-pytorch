##### CARLOS CODE FILE ########
### THIS IS THE OLD CODE FILE (I HAD TO REFACTOR THIS)
...
class AttentionArchitecture(nn.Module):
    def __init__(self, in_channels_list, out_channels, mode, phase, position_awareness, residualconn, groupnorm, query_focused_residualconn):
        ...
        self.query_focused_residualconn = query_focused_residualconn
    ...
    def forward_onlyupper_pyramidial(self, x):
        ...
        for i in range(self.num_levels - 2, -1, -1):
            ...
            if self.query_focused_residualconn:
                output_attentioned = output_attentioned + Q.transpose(1, 2).view(batch, d_model, H_querylayer, W_querylayer)
    ...
    def forward_upperandlower_pyramidial(self, x):
        ...
        for i in range(self.num_levels - 2, -1, -1):
            ...
            if self.query_focused_residualconn:
                Q_new = Q.transpose(1, 2).view(batch, d_model, H_querylayer, W_querylayer)
