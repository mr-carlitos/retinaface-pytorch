...
def match(threshold, truths, priors, variances, labels, landms, loc_t, conf_t, landm_t, idx):
    ...
    # the loop ensures that for each ground-truth box (indexed by j), the corresponding best prior (from best_prior_idx) is explicitly assigned to that ground-truth
