...
parser.add_argument('-m', '--trained_model', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-05-23_RetinaFace_CROSS_ATT_FROMUPPER_gradientacc/CROSSATTENTION_FROMUPPER_gradientacc_best.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--origin_size', default=False, type=bool, help='Whether use origin image size to evaluate')
parser.add_argument('--save_folder', default='/home/user/ckirchdorfer/carlos-workspace/Pytorch_Retinaface/save-checkpoints/2025-05-23_RetinaFace_CROSS_ATT_FROMUPPER_gradientacc/like-mxnet/', type=str, help='Dir to save txt results')
